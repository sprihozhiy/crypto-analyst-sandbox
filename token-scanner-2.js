...
const CheckERC20Safety = async (address) => {
    ...
    try {
        ...
        if (result) {
          ...
          let bnbWorth = Math.round(buyActualOut / 10**15) / 10**3;


          if (buy_tax + sell_tax > 50) {
            // Extreme high tax
            return `Honeypot: Yes, Buy Tax: ${buy_tax}, Sell Tax: ${sell_tax}, BNB Worth: ${bnbWorth}`;
          }
          ...
          return `Honeypot: No, Buy Tax: ${buy_tax}, Sell Tax: ${sell_tax}, BNB Worth: ${bnbWorth}`;
